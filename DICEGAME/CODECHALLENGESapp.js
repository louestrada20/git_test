...
var scores, roundScore, activePlayer, gamePlaying, prevDice, prevDice2;  // Declared variables in the global scope to use them in other functions. 
...
document.querySelector('.btn-roll').addEventListener('click', function() {
  ...
  if (dice !== 1 && dice2 !== 1) {
        //Add score
        roundScore += dice + dice2; // same thing as writing roundScore = roundScore + dice
...
var winningScore;
var input =  document.getElementById('inpt-new').value;
